[![Build Status](https://travis-ci.org/thilina01/nbiz-ee.svg?branch=master)](https://travis-ci.org/thilina01/nbiz-ee)
# nBizEE
...
To optimize the nBizEE application for production, run:
