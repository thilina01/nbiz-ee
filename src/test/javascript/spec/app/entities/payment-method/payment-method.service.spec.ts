    ...
    describe('PaymentMethod Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a PaymentMethod', () => {
                service.create(new PaymentMethod(null)).subscribe(received => {
            ...
            it('should update a PaymentMethod', () => {
                service.update(new PaymentMethod(123)).subscribe(received => {
            ...
            it('should return a PaymentMethod', () => {
            ...
            it('should return a list of PaymentMethod', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new PaymentMethod(123)]);
            });
