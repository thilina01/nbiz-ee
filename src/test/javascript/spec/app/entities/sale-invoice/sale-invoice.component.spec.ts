...
import { SaleInvoiceComponent } from 'app/entities/sale-invoice/sale-invoice.component';
...
describe('Component Tests', () => {
    describe('SaleInvoice Management Component', () => {
        let comp: SaleInvoiceComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SaleInvoiceComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.saleInvoices[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
