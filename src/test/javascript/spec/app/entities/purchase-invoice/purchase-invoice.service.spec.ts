    ...
    describe('PurchaseInvoice Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/purchase-invoices';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a PurchaseInvoice', () => {
                service.create(new PurchaseInvoice(null)).subscribe(received => {
            ...
            it('should update a PurchaseInvoice', () => {
                service.update(new PurchaseInvoice(123)).subscribe(received => {
            ...
            it('should return a PurchaseInvoice', () => {
            ...
            it('should return a list of PurchaseInvoice', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new PurchaseInvoice(123)]);
            });
