...
describe('Service Tests', () => {
    describe('QuotationItem Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(QuotationItemService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/quotation-items';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a QuotationItem', () => {
                service.create(new QuotationItem(null)).subscribe(received => {
            ...
            it('should update a QuotationItem', () => {
                service.update(new QuotationItem(123)).subscribe(received => {
            ...
            it('should return a QuotationItem', () => {
            ...
            it('should return a list of QuotationItem', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new QuotationItem(123)]);
            });
