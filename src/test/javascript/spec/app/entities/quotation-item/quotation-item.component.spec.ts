...
import { QuotationItemComponent } from 'app/entities/quotation-item/quotation-item.component';
...
describe('Component Tests', () => {
    describe('QuotationItem Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.quotationItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
